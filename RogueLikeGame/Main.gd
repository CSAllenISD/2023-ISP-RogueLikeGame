...
var Room = preload("res://RogueLikeGame/Room.tscn")
var Player = preload("res://RogueLikeGame/Characters/OldPlayer/OldCharacter.tscn")
var font = preload("res://RogueLikeGame/title_screen/Fonts/alagard.ttf")
