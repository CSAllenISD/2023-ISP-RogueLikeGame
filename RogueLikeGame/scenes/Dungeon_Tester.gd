...
var dungeon = {}
var node_sprite = load("res://RogueLikeGame/assets/mapgeneration/map_nodes1.png")
var branch_sprite = load("res://RogueLikeGame/assets/mapgeneration/map_nodes3.png")
